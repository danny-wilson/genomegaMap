 ...
 *
 */
#ifndef _OMEGAMAP_NCD2_H_
#define _OMEGAMAP_NCD2_H_
...
class omegaMapNCD2 : public Distribution {
private:
	...
	// I.e. indexed by species (0 pop, 1 pop, 0 branch, 1 branch), then RV, then site, then codon state
...
public:
	// Constructor
	omegaMapNCD2(string name="", DAG* dag=0);
	// Copy constructor
	omegaMapNCD2(const omegaMapNCD2& x);

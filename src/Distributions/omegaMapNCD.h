 ...
 *
 */
#ifndef _OMEGAMAP_NCD_H_
#define _OMEGAMAP_NCD_H_
...
class omegaMapNCD : public Distribution {
private:
...
public:
	// Constructor
	omegaMapNCD(string name="", DAG* dag=0);
	// Copy constructor
	omegaMapNCD(const omegaMapNCD& x);

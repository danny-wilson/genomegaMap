 ...
 *
 */
#ifndef _NORMAL_QUANTILE_VECTOR_TRANSFORM_H_
#define _NORMAL_QUANTILE_VECTOR_TRANSFORM_H_
...
class NormalQuantileVectorTransform : public ContinuousVectorVariable, public Transformation {
private:
	int _n;
...
public:
	// Constructor
	NormalQuantileVectorTransform(const int n, string name="", DAG* dag=0);
	// Copy constructor
	NormalQuantileVectorTransform(const NormalQuantileVectorTransform& x);
...
#endif // _NORMAL_QUANTILE_VECTOR_TRANSFORM_H_
